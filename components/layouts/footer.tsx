        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold text-foreground">EventApp</h3>
            </div>
            <p className="text-muted-foreground mb-6 max-w-md">
              Nền tảng đăng ký sự kiện hàng đầu Việt Nam, kết nối cộng đồng và tạo ra những trải nghiệm tuyệt vời.
            </p>
        ...
        <div className="border-t border-border mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-muted-foreground text-sm">
              © {currentYear} EventApp. Tất cả quyền được bảo lưu.
            </p>
